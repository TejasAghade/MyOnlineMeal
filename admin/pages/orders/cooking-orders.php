			...
			<div id="manage-order-data">
				...
				<div class="card card-main p-top" style="min-height:485px">
					...
					<div class="card-header mx-2 card-header-text">
						...
						<h4 class="card-title text-danger">Cooking Orders</h4>
					...
					$sql2 = "SELECT * from orders where order_status='cooking' ORDER BY id desc";
    ...
    <div class="modal-dialog" style="width: 500px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
				...
				<button class="btn btn-primary " onclick="change_payment_delivery_status('cooking-orders')">Save</button>
			</form>
            </div>
        </div>
    </div>
