			...
			<div id="manage-order-data">
				...
				<div class="card card-main p-top" style="min-height:485px">
					...
					<div class="card-header mx-2 card-header-text">
						...
						<h4 class="card-title text-danger">On The Way Orders</h4>
					...
					$sql2 = "SELECT * from orders where order_status='on the way' ORDER BY id desc";
						...
						while($order_row = mysqli_fetch_assoc($order_result)){
							...
							$concat1 =' 
                                    ...
                                    <tr id="tr_'.$id.'"">
                                        ...
                                        <td id="payment_type" >'.$order_row['payment_type'].'</td>
										...
										<td id="order_time" >'.$order_row['order_time'].'</td>
    ...
    <div class="modal-dialog" style="width: 500px;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
				...
				<button class="btn btn-primary " onclick="change_payment_delivery_status('on-the-way-orders')">Save</button>
			</form>
            </div>
        </div>
    </div>
